...
class Videollama2MetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        # print('0000000000', input_ids)
        # import transformers
        # tokenizer = transformers.AutoTokenizer.from_pretrained(
        #     '/home/sharing/disk2/zhanghanlei/videollama2/finetune_downstream_sft_settings_lora/checkpoint-500',
