...
class Videollama2MistralForCausalLM(MistralForCausalLM, Videollama2MetaForCausalLM):
    ...
    def generate(
        ...
        **kwargs,
        ...
        # # 初始化tokenizer
        # tokenizer = AutoTokenizer.from_pretrained('/home/sharing/disk1/llm_checkpoints/Mistral-7B-Instruct-v0.2')
        # input_ids = tokenizer(inputs, return_tensors='pt', truncation=True, padding=True)
        # print('1111111111111111', input_ids)
